defmodule Mix.Tasks.LidlChef.CheckServices do
  ...
  def run(_args) do
    ...
    Mix.shell().info("Embedder process (#{embedder_name}): #{if embedder_alive, do: "✅ Running", else: "❌ Not running"}")
    ...
    Mix.shell().info("NER process (#{ner_name}): #{if ner_alive, do: "✅ Running", else: "❌ Not running"}")
